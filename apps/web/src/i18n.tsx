...
const zh: Record<string, string> = {
  ...
  "profile.avatar": "头像",
  "profile.avatarHint": "可填 https 图片地址，或上传本机 JPG/PNG（有大小限制）。",
  "profile.avatarLocalNote": "当前为本地图片数据，保存后将写入个人资料。",
  "profile.avatarUpload": "上传图片",
  ...
  "profile.saved": "已保存",
  "profile.failed": "保存失败",
  "profile.avatarTooLarge": "图片须不超过 96KB。",
...
const en: Record<string, string> = {
  ...
  "profile.avatarHint": "Use an https image URL, or upload a JPG/PNG (size-limited).",
  ...
  "profile.avatarTooLarge": "Image must be at most 96KB.",
