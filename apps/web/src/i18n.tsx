...
const zh: Record<string, string> = {
  ...
  "bench.template": "模板",
  "bench.tipAddOffense": "点击球场放置进攻球员；选中球队队员后，也可点击场上进攻球员替换。",
...
const en: Record<string, string> = {
  ...
  "bench.tipAddOffense": "Click the court to place an offensive player; after choosing a roster player, click an on-court offensive player to replace them.",
