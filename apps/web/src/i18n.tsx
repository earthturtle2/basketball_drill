...
const zh: Record<string, string> = {
  ...
  "edit.libraryVisibleAll": "该战术在「战术模版库」中对全部教练可见（新战术默认即如此，仅管理员可改为不展示）。",
  "edit.libraryHidden": "该战术已从「战术模版库」中隐藏，仅您自己可在「我的战术」中查看与编辑。",
...
const en: Record<string, string> = {
  ...
  "edit.libraryVisibleAll": "This play is listed in the template library for all coaches (the default; only an admin can hide it).",
